 ...
 */
            ...
            /**
            *  ConfirmPaymentResponse bean class
            */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":confirmPaymentResponse",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "confirmPaymentResponse",
    ...
    public static class Factory{
        ...
        */
        public static ConfirmPaymentResponse parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConfirmPaymentResponse object =
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"confirmPaymentResponse".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConfirmPaymentResponse)com.autoinc.servicepayment.paymentservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
