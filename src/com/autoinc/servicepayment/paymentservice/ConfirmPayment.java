 ...
 */
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":confirmPayment",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "confirmPayment",
    ...
    public static class Factory{
        ...
        */
        public static ConfirmPayment parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ConfirmPayment object =
                new ConfirmPayment();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"confirmPayment".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ConfirmPayment)com.autoinc.servicepayment.paymentservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
